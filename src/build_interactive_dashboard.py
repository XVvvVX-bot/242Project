    ...
    <main>
      ...
      <section class="slide content-slide">
        ...
        <div class="formula-panel">
          <div class="formula">window x = [y(t-L), ..., y(t-1)]<br>mu = mean(x), sigma = std(x)</div>
          <div class="formula">z = (x - mu) / sigma<br>model input = z plus calendar and series features</div>
          <div class="formula">model predicts z_hat(t)<br>final forecast y_hat(t) = z_hat(t) * sigma + mu</div>
          <div class="flow-list">
